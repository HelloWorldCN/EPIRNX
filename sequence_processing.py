...
for cell_line in cell_lines:
    Data_dir = 'G:/Data/EPIs/{}/'.format(cell_line)
    ...
    im_enhancers_tra, im_promoters_tra, y_imtra = get_ont_hot(im_enhancers_tra, im_promoters_tra, y_imtra, 3000, 2000)
    enhancers_tes, promoters_tes, y_tes = get_ont_hot(enhancers_tes, promoters_tes, y_tes, 3000, 2000)

    print("enhancers_tra.shape={}, promoters_tra.shape={}, y_tra.shape={}".format(enhancers_tra.shape, promoters_tra.shape, y_tra.shape))
    print("im_enhancers_tra.shape={}, im_promoters_tra.shape={}, y_imtra.shape={}".format(im_enhancers_tra.shape, im_promoters_tra.shape, y_imtra.shape))
    print("enhancers_tes.shape={}, promoters_tes.shape={}, y_tes.shape={}".format(enhancers_tes.shape, promoters_tes.shape, y_tes.shape))
